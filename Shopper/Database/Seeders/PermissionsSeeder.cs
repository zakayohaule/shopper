    ...
    public static class PermissionsSeeder
    {
        public static void Seed(ApplicationDbContext dbContext, ILogger logger)
        {
            ...
            var permissions = new List<Permission>
            {
                ...
                new Permission {Name = "institution_add", DisplayName = "Create Institution", Module = institutionManagement},
                new Permission {Name = "institution_edit", DisplayName = "Edit Institution", Module = institutionManagement},
                new Permission {Name = "institution_view", DisplayName = "View Institution", Module = institutionManagement},
                new Permission {Name = "institution_delete", DisplayName = "Delete Institution", Module = institutionManagement},
                ...
                new Permission {Name = "software_add_endpoint", DisplayName = "Add Software Endpoint", Module = softwareManagement},
                new Permission {Name = "software_edit_endpoint", DisplayName = "Edit Software Endpoint", Module = softwareManagement},
                new Permission {Name = "software_delete_endpoint", DisplayName = "Delete Software Endpoint", Module = softwareManagement},
                new Permission {Name = "connection_request_received", DisplayName = "View Received Connection Requests", Module = softwareManagement},
                new Permission {Name = "connection_request_sent", DisplayName = "View Sent Connection Requests", Module = softwareManagement},
            }.ToList();
