"use strict";
$.fn.mboardmenu = function(settings) {
    var oid = this.attr("id");
    // mboard Menu default settings:
    var defaults = {
    ...
    var mboardMenu = {
        mboardMenuInit: function() {
            mboardMenu.Handlethemelayout();
            mboardMenu.HandleverticalMenuplacement();
            mboardMenu.HandlehorizontalMenuplacement();
            mboardMenu.HandleMenulayout();
            mboardMenu.HandleDeviceType();
            mboardMenu.Handlecomponetheight();
            mboardMenu.HandleMenuOnClick();
            mboardMenu.HandleMenuTrigger();
            mboardMenu.HandleSubMenuTrigger();
            mboardMenu.HandleActiveItem();
            mboardMenu.HandleOffcanvasMenu();
            mboardMenu.HandleVerticalLeftHeader();
            mboardMenu.HandleThemeBackground();
            mboardMenu.HandleActiveItemStyle();
            mboardMenu.HandleItemBorder();
            mboardMenu.HandleBorderStyle();
            mboardMenu.HandleSubItemBorder();
            mboardMenu.HandleDropDownIconStyle();
            mboardMenu.HandleOptionSelectorPanel();
            mboardMenu.HandleNavbarPosition();
            mboardMenu.HandleVerticalSubMenuItemIconStyle();
            mboardMenu.HandleVerticalNavigationView();
            mboardMenu.HandleHorizontalItemIsCentered();
            mboardMenu.HandleHorizontalItemAlignment();
            mboardMenu.HandleSubMenuOffset();
            mboardMenu.HandleHorizontalStickyNavigation();
            mboardMenu.HandleDocumentClickEvent();
            mboardMenu.HandleVerticalScrollbar();
            mboardMenu.HandleHorizontalMobileMenuToggle();
            mboardMenu.horizontalNavigationMenuIcon();
            mboardMenu.verticalNavigationSearchBar();
            mboardMenu.safariBrowsercompatibility();
            mboardMenu.Handlemenutype();
            mboardMenu.Handlelayoutvartype();
        },
        ...
        verticalNavigationSearchBar: function() {
            if (settings.themelayout === "vertical") {
                $('.searchbar-toggle').on('click', function() {
                    $(this).parent('.mboard-search').toggleClass('open');
                });
            }
        },
        horizontalNavigationMenuIcon: function() {
            if (settings.themelayout === "horizontal") {
                switch (settings.horizontalNavigationMenuIcon) {
                    case false:
                        $('#' + oid + '.mboard .mboard-navbar .mboard-item > li > a .mboard-micon').hide();
                        $('#' + oid + '.mboard .mboard-navbar .mboard-item.mboard-search-item > li > a .mboard-micon').show();
                        break;
                    default:
                }
            }
        ...
        HandleHorizontalMobileMenuToggle: function() {
            if (settings.themelayout === "horizontal") {
                $('#mobile-collapse').on('click', function() {
                    $('.mboard-navbar').toggleClass('show-menu')
                });
            }
        },
        ...
        HandleDocumentClickEvent: function() {
            function closeSubMenu() {
                $(document).on('click', function(evt) {
                    ...
                    var sdt = $('#' + oid).attr('mboard-device-type');
                    var vnt = $('#' + oid).attr('vertical-nav-type');
                    var el = $('#' + oid + ' .mboard-item li');
                    if (!target.parents('.mboard-item').length) {
                        if (sdt != "phone") {
                            if (vnt != "expanded") {
                                el.removeClass('mboard-trigger');
                            }
                        }
                    }
                });
            ...
            function closeLeftbarSearch() {
                $(document).on('click', function(evt) {
                    var target = $(evt.target);
                    var el = $('#' + oid + ' .mboard-search');
                    if (!target.parents('.mboard-search').length) {
                        el.removeClass('open');
                    }
            ...
            switch (settings.horizontalstickynavigation) {
                case true:
                    $(window).on('scroll', function() {
                        ...
                        if (scrolltop >= 100) {
                            $('.mboard-navbar').addClass('stickybar');
                            $('stickybar').fadeIn(3000);
                        } else if (scrolltop <= 100) {
                            $('.mboard-navbar').removeClass('stickybar')
        ...
        HandleSubMenuOffset: function() {
            switch (settings.themelayout) {
                case 'horizontal':
                    ...
                    if (trigger === "hover") {
                        $("li.mboard-hasmenu").on('mouseenter mouseleave', function(e) {
                            if ($('.mboard-submenu', this).length) {
                                var elm = $('.mboard-submenu:first', this);
                                var off = elm.offset();
                                var l = off.left;
                                var w = elm.width();
                                var docH = $(window).height();
                                var docW = $(window).width();
								//console.log("length = " + $('.mboard-submenu', this).length + " off=" + off + " l=" + l+ " w=" + w + " doch=" + docH + " docW=" + docW)
                        ...
                        $("li.mboard-hasmenu").on('click', function(e) {
                            e.preventDefault();
                            if ($('.mboard-submenu', this).length) {
                                var elm = $('.mboard-submenu:first', this);
                                var off = elm.offset();
        ...
        HandleHorizontalItemIsCentered: function() {
            if (settings.themelayout === "horizontal") {
                switch (settings.horizontalNavIsCentered) {
                    case true:
                        $('#' + oid + ' .mboard-navbar').addClass("isCentered");
                        break;
                    case false:
                        $('#' + oid + ' .mboard-navbar').removeClass("isCentered");
                        break;
                    default:
                }
            }
        ...
        HandleHorizontalItemAlignment: function() {
            ...
            if (layout === "horizontal") {
                function branditemalignment() {
                    var elm = $('#' + oid + '.mboard .mboard-navbar .mboard-brand');
                    if (settings.horizontalBrandItem === true) {

                        switch (settings.horizontalBrandItemAlign) {
                            case 'left':
                                elm.removeClass('mboard-right-align');
                                elm.addClass('mboard-left-align');
                                break;
                            case 'right':
                                elm.removeClass('mboard-left-align');
                                elm.addClass('mboard-right-align');
                                break;
                            default:
                        }
                    } else {
                ...
                function leftitemalignment() {
                    var elm = $('#' + oid + '.mboard .mboard-navbar .mboard-item.mboard-left-item');
                ...
                function rightitemalignment() {
                    var elm = $('#' + oid + '.mboard .mboard-navbar .mboard-item.mboard-right-item');
                ...
                function searchitemalignment() {
                    var elm = $('#' + oid + '.mboard .mboard-navbar .mboard-search-item');
        ...
        HandleVerticalNavigationView: function() {
            switch (settings.themelayout) {
                case 'vertical':
                    ...
                    $('#' + oid + '.mboard').attr("vnavigation-view", ev);
                    break;
                case 'horizontal':
                    var ev = settings.horizontalNavigationView;
                    $('#' + oid + '.mboard').attr("hnavigation-view", ev);
                    break;
                default:
            }
        },
        HandleVerticalSubMenuItemIconStyle: function() {
            switch (settings.themelayout) {
                case 'vertical':
                    ...
                    $('#' + oid + ' .mboard-navbar .mboard-hasmenu').attr("subitem-icon", ev);
                    break;
                case 'horizontal':
                    $('#' + oid + ' .mboard-navbar .mboard-hasmenu').attr("subitem-icon", ev);
                    break;
        ...
        HandleNavbarPosition: function() {
            ...
            switch (settings.themelayout) {
                case 'vertical':
                    if (navposition == true) {
                        $('#' + oid + ' .mboard-navbar').attr("mboard-navbar-position", 'fixed');
                        $('#' + oid + ' .mboard-header .mboard-left-header').attr("mboard-lheader-position", 'fixed');
                    } else {
                        $('#' + oid + ' .mboard-navbar').attr("mboard-navbar-position", 'absolute');
                        $('#' + oid + ' .mboard-header .mboard-left-header').attr("mboard-lheader-position", 'absolute');
                    }
                    if (headerposition == true) {
                        $('#' + oid + ' .mboard-header').attr("mboard-header-position", 'fixed');
                        $('#' + oid + ' .mboard-main-container').css('margin-top', $(".mboard-header").outerHeight());

                    } else {
                        $('#' + oid + ' .mboard-header').attr("mboard-header-position", 'relative');
                        $('#' + oid + ' .mboard-main-container').css('margin-top', '0px');
                    }
                    break;
                case 'horizontal':
                    if (navposition == true) {
        ...
        HandleDropDownIconStyle: function() {
            ...
            switch (settings.themelayout) {
                case 'vertical':
                    $('#' + oid + ' .mboard-navbar .mboard-hasmenu').attr("dropdown-icon", ev);
                    break;
                case 'horizontal':
                    $('#' + oid + ' .mboard-navbar .mboard-hasmenu').attr("dropdown-icon", ev);
                    break;
        ...
        HandleSubItemBorder: function() {
            switch (settings.SubItemBorder) {
                case true:
                    $('#' + oid + ' .mboard-navbar .mboard-item').attr("subitem-border", "true");
                    break;
                case false:
                    $('#' + oid + ' .mboard-navbar .mboard-item').attr("subitem-border", "false");
                    break;
                default:
            }
        },
        HandleBorderStyle: function() {
            ...
            switch (settings.ItemBorder) {
                case true:
                    $('#' + oid + ' .mboard-navbar .mboard-item').attr("item-border-style", ev);
                    break;
                case false:
                    $('#' + oid + ' .mboard-navbar .mboard-item').attr("item-border-style", "");
                    break;
                default:
            }
        },
        HandleItemBorder: function() {
            switch (settings.ItemBorder) {
                case true:
                    $('#' + oid + ' .mboard-navbar .mboard-item').attr("item-border", "true");
                    break;
                case false:
                    $('#' + oid + ' .mboard-navbar .mboard-item').attr("item-border", "false");
                    break;
                default:
            }
        },
        HandleActiveItemStyle: function() {
            ...
            if (ev != undefined && ev != "") {
                $('#' + oid + ' .mboard-navbar').attr("active-item-style", ev);
            } else {
                $('#' + oid + ' .mboard-navbar').attr("active-item-style", "style0");
            }
        },
        ...
        HandleThemeBackground: function() {
            ...
            function setheadertheme() {
                ...
                if (ev != undefined && ev != "") {
                    $('#' + oid + ' .mboard-header').attr("header-theme", ev);
                } else {
                    $('#' + oid + ' .mboard-header').attr("header-theme", "theme1");
                }
            };
            ...
            function setlheadertheme() {
                ...
                if (ev != undefined && ev != "") {
                    $('#' + oid + ' .mboard-header .navbar-logo').attr("logo-theme", ev);
                    $('#' + oid + ' .mboard-navigatio-lavel').attr("menu-title-theme", "theme5");
                } else {
                    $('#' + oid + ' .mboard-header .navbar-logo').attr("logo-theme", "theme4");
                    $('#' + oid + ' .mboard-navigatio-lavel').attr("menu-title-theme", "theme5");
                }
            };
            ...
            function setnavbartheme() {
                ...
                if (ev != undefined && ev != "") {
                    $('#' + oid + ' .mboard-navbar').attr("navbar-theme", ev);
                } else {
                    $('#' + oid + ' .mboard-navbar').attr("navbar-theme", "theme1");
                }
            };
            ...
            function setactiveitemtheme() {
                ...
                if (ev != undefined && ev != "") {
                    $('#' + oid + ' .mboard-navbar').attr("active-item-theme", ev);
                } else {
                    $('#' + oid + ' .mboard-navbar').attr("active-item-theme", "theme1");
                }
            };
            ...
            function setsubitemtheme() {
                ...
                if (ev != undefined && ev != "") {
                    $('#' + oid + ' .mboard-navbar').attr("sub-item-theme", ev);
                } else {
                    $('#' + oid + ' .mboard-navbar').attr("sub-item-theme", "theme1");
                }
            };
        ...
        HandleVerticalLeftHeader: function() {
            if (settings.themelayout === "vertical") {
                switch (settings.collapseVerticalLeftHeader) {
                    case true:
                        $('#' + oid + ' .mboard-header').addClass('iscollapsed');
                        $('#' + oid + ' .mboard-header').removeClass('nocollapsed');
                        $('#' + oid + '.mboard').addClass('iscollapsed');
                        $('#' + oid + '.mboard').removeClass('nocollapsed');

                        /*  $('#'+oid + ' .mboard-header.nocollapsed .mboard-left-header').css('width', '');  */
                        break;
                    case false:
                        $('#' + oid + ' .mboard-header').removeClass('iscollapsed');
                        $('#' + oid + ' .mboard-header').addClass('nocollapsed');
                        $('#' + oid + '.mboard').removeClass('iscollapsed');
                        $('#' + oid + '.mboard').addClass('nocollapsed');
                        /*  $('#'+oid + ' .mboard-header.nocollapsed .mboard-left-header').css('width', $(".mboard-navbar").width());  */
                        break;
                    default:
                }
            } else {
        ...
        HandleActiveItem: function() {
            /*switch(settings.activeMenuClass){
            	case  "active":
            		$('li:not("li.mboard-hasmenu")').on( 'click', function () {
            			var str = $(this).closest('.mboard-submenu').length;
            			if (str === 0){
            				$(this).closest('.mboard-inner-navbar').find('li.active').removeClass('active');
            				...
            				if($(this).hasClass('active')){
            					...
            					$(this).closest('.mboard-inner-navbar').find('li.active').removeClass('active');
            					$(this).parents('.mboard-hasmenu').addClass('active');
            					$(this).addClass('active');
            				}
            			}
            		});
            		break;
            	case  false:
            		$('.mboard-header').removeClass(settings.navbbgclass);
            		break;
            	default:
            }*/
        },
        HandleSubMenuTrigger: function() {
            switch (settings.SubMenuTrigger) {
                case 'hover':
                    $('#' + oid + ' .mboard-navbar .mboard-hasmenu').addClass('is-hover');
                    // Initialize
                    var $window = $(window);
                    var $dropdown = $('.mboard-submenu > li');
                    ...
                    function bindTwo(eventType) {
                        if (eventType == 'hover') {
                            ...
                            $dropdown.off('click').off('mouseenter mouseleave').hover(
                                function() {
                                    $(this).addClass('mboard-trigger');
                                },
                                function() {
                                    $(this).removeClass('mboard-trigger');
                                }
                            );
                            ...
                            $dropdown.off('mouseenter mouseleave').off('click').on('click',
                                function(e) {
                                    ...
                                    var str = $(this).closest('.mboard-submenu').length;
                                    if (str === 0) {
                                        if ($(this).hasClass('mboard-trigger')) {
                                            $(this).removeClass('mboard-trigger');
                                        } else {
                                            $(this).closest('.mboard-inner-navbar').find('li.mboard-trigger').removeClass('mboard-trigger');
                                            $(this).addClass('mboard-trigger');
                                        }
                                    } else {
                                        if ($(this).hasClass('mboard-trigger')) {
                                            ...
                                            $(this).closest('.mboard-submenu').find('li.mboard-trigger').removeClass('mboard-trigger');
                                            $(this).addClass('mboard-trigger');
                                        }
                                    }
                                }
                    ...
                    break;
                case 'click':
                    $('#' + oid + ' .mboard-navbar .mboard-hasmenu').removeClass('is-hover');
                    $(".mboard-submenu > li").on('click', function(e) {
                        e.stopPropagation();
                        var str = $(this).closest('.mboard-submenu').length;
                        if (str === 0) {
                            if ($(this).hasClass('mboard-trigger')) {
        ...
        HandleMenuTrigger: function() {
            ...
            switch (settings.MenuTrigger) {
                case 'hover':
                    $('#' + oid + ' .mboard-navbar').addClass('is-hover');
                    // Initialize
                    var $window = $(window);
                    var $dropdown = $(".mboard-item > li");
                    var currentSize = $window.width();
                    var currentEvent = '';
                    // Attach current event on load
                    ...
                    break;
                case 'click':
                    $('#' + oid + ' .mboard-navbar').removeClass('is-hover');
                    $(".mboard-item > li ").on('click', function() {
                        if ($(this).hasClass('mboard-trigger')) {
                            $(this).removeClass('mboard-trigger');
                        } else {
                            $(this).closest('.mboard-inner-navbar').find('li.mboard-trigger').removeClass('mboard-trigger');
        ...
        HandleMenuOnClick: function() {
            ...
            if (settings.themelayout === "vertical") {
                $('#mobile-collapse,.sidebar_toggle a, .mboard-overlay-box,.menu-toggle a').on("click", function() {
                    $(this).parent().find('.menu-icon').toggleClass("is-clicked");
                    var dt = $('#' + oid).attr("mboard-device-type");
                    if (dt == "desktop") {
                    ...
                    $('.mboard').addClass("mboard-toggle-animate");
                    setTimeout(function() {
                        $('.mboard').removeClass("mboard-toggle-animate");
                    }, 250);
                });
            } else if (settings.themelayout === "horizontal") {
                if (totalwidth >= 768 && totalwidth <= 992) {
                    $('#' + oid).attr("mboard-device-type", "tablet");
                } else if (totalwidth < 768) {
                    $('#' + oid).attr("mboard-device-type", "phone");
                } else {
                    $('#' + oid).attr("mboard-device-type", "desktop");
                }
            }
        },
        Handlecomponetheight: function() {
            function setHeight() {
                ...
                var HH = $(".mboard-header").innerHeight();
                var NH = $(".mboard-navbar").innerHeight();
                var FH = $(".mboard-footer").innerHeight();
                var contentHH = WH - HH;
                var contentVH = WH - HH;
                var lpanelH = WH - HH;
                // if (settings.themelayout === "horizontal" ) {
                // 	$(".mboard-navbar").css('height', contentHH);
                // } else if (settings.themelayout === "vertical" ) {
                // 	if ( contentVH >= lpanelH ){
                // 		$(".mboard-navbar").css('height', contentVH);
                // 	}else {
                // 		$(".mboard-navbar").css('height', lpanelH);
                // 	}
                // } else {
                // 	return false;
                // }
        ...
        HandleDeviceType: function() {
            ...
            $(window).resize(function() {
                ...
                dt = $('#' + oid).attr('mboard-device-type')
    ...
    mboardMenu.mboardMenuInit();
};
// menu [ vertical ]
$(window).scroll(function() {
    if ($(this).scrollTop() > 80) {
        $('.mboard[theme-layout="vertical"] .mboard-navbar[mboard-navbar-position="fixed"][mboard-header-position="relative"]').css('position', 'fixed');
        $('.mboard[theme-layout="vertical"] .mboard-navbar[mboard-navbar-position="fixed"][mboard-header-position="relative"]').css('top', 0);
    } else {
        $('.mboard[theme-layout="vertical"] .mboard-navbar[mboard-navbar-position="fixed"][mboard-header-position="relative"]').css('position', 'absolute');
        $('.mboard[theme-layout="vertical"] .mboard-navbar[mboard-navbar-position="fixed"][mboard-header-position="relative"]').css('top', 'auto');
    }
});
// menu [ horizontal ]
$(window).scroll(function() {
    if ($(this).scrollTop() > 80) {
        $('.mboard[theme-layout="horizontal"][mboard-device-type="desktop"] .mboard-navbar[mboard-navbar-position="fixed"][mboard-header-position="relative"]').css('position', 'fixed');
        $('.mboard[theme-layout="horizontal"][mboard-device-type="desktop"] .mboard-navbar[mboard-navbar-position="fixed"][mboard-header-position="relative"]').css('top', 0);
    } else {
        $('.mboard[theme-layout="horizontal"][mboard-device-type="desktop"] .mboard-navbar[mboard-navbar-position="fixed"][mboard-header-position="relative"]').css('position', 'absolute');
        $('.mboard[theme-layout="horizontal"][mboard-device-type="desktop"] .mboard-navbar[mboard-navbar-position="fixed"][mboard-header-position="relative"]').css('top', 'auto');
    }
});
