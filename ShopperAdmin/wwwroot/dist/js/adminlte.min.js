...
!function (e, t) {
  ...
  var i = a(t), n = "CardRefresh", s = i.default.fn[n], o = {
    source: "",
    sourceSelector: "",
    params: {},
    ...
    function e(e, t) {
      if (this._element = e, this._parent = e.parents(".card").first(), this._settings = i.default.extend({}, o, t), this._overlay = i.default(this._settings.overlayTemplate), e.hasClass("card") && (this._parent = e), "" === this._settings.source) throw new Error("Source url was not defined. Please specify a url in your CardRefresh source option.")
    }
    ...
    return t.load = function () {
      ...
      var a = i.default(this).data("lte.cardrefresh"), n = i.default.extend({}, o, i.default(this).data());
      a || (a = new e(i.default(this), n), i.default(this).data("lte.cardrefresh", "string" == typeof t ? a : t)), "string" == typeof t && t.match(/load/) ? a[t]() : a._init(i.default(this))
    }, e
  }();
  ...
  var r = "CardWidget", d = i.default.fn[r], u = {
    ...
    function e(e, t) {
      this._element = e, this._parent = e.parents(".card").first(), e.hasClass("card") && (this._parent = e), this._settings = i.default.extend({}, u, t)
    }
    ...
    return t.collapse = function () {
      ...
      var a = i.default(this).data("lte.cardwidget"), n = i.default.extend({}, u, i.default(this).data());
      a || (a = new e(i.default(this), n), i.default(this).data("lte.cardwidget", "string" == typeof t ? a : t)), "string" == typeof t && t.match(/collapse|expand|remove|toggle|maximize|minimize|toggleMaximize/) ? a[t]() : "object" == typeof t && a._init(i.default(this))
    }, e
  }();
  i.default(document).on("click", '[data-card-widget="collapse"]', (function (e) {
    e && e.preventDefault(), f._jQueryInterface.call(i.default(this), "toggle")
  })), i.default(document).on("click", '[data-card-widget="remove"]', (function (e) {
    e && e.preventDefault(), f._jQueryInterface.call(i.default(this), "remove")
  })), i.default(document).on("click", '[data-card-widget="maximize"]', (function (e) {
    e && e.preventDefault(), f._jQueryInterface.call(i.default(this), "toggleMaximize")
  })), i.default.fn[r] = f._jQueryInterface, i.default.fn[r].Constructor = f, i.default.fn[r].noConflict = function () {
    return i.default.fn[r] = d, f._jQueryInterface
  };
  var c = "ControlSidebar", h = i.default.fn[c],
    g = {controlsidebarSlide: !0, scrollbarTheme: "os-theme-light", scrollbarAutoHide: "l"}, p = function () {
      function e(e, t) {
      ...
      return t.collapse = function () {
        ...
        this._config.controlsidebarSlide ? (t.addClass("control-sidebar-animate"), e.removeClass("control-sidebar-slide-open").delay(300).queue((function () {
          i.default(".control-sidebar").hide(), t.removeClass("control-sidebar-animate"), i.default(this).dequeue()
        }))) : e.removeClass("control-sidebar-open"), i.default(this._element).trigger(i.default.Event("collapsed.lte.controlsidebar"))
      }, t.show = function () {
        var e = i.default("body"), t = i.default("html");
        this._config.controlsidebarSlide ? (t.addClass("control-sidebar-animate"), i.default(".control-sidebar").show().delay(10).queue((function () {
        ...
        var e = this;
        this._fixHeight(), this._fixScrollHeight(), i.default(window).resize((function () {
        ...
        if (e.hasClass("layout-fixed")) {
          var t = {
            ...
            }, a = Math.abs(t.window + i.default(window).scrollTop() - t.scroll), n = i.default(window).scrollTop(),
            s = (e.hasClass("layout-navbar-fixed") || e.hasClass("layout-sm-navbar-fixed") || e.hasClass("layout-md-navbar-fixed") || e.hasClass("layout-lg-navbar-fixed") || e.hasClass("layout-xl-navbar-fixed")) && "fixed" === i.default(".main-header").css("position"),
            o = (e.hasClass("layout-footer-fixed") || e.hasClass("layout-sm-footer-fixed") || e.hasClass("layout-md-footer-fixed") || e.hasClass("layout-lg-footer-fixed") || e.hasClass("layout-xl-footer-fixed")) && "fixed" === i.default(".main-footer").css("position"),
            l = i.default(".control-sidebar"),
            r = i.default(".control-sidebar, .control-sidebar .control-sidebar-content");
          if (0 === n && 0 === a) l.css({
            bottom: t.footer,
            top: t.header
          }), r.css("height", t.window - (t.header + t.footer)); else if (a <= t.footer) if (!1 === o) {
            var d = t.header - n;
            l.css("bottom", t.footer - a).css("top", d >= 0 ? d : 0), r.css("height", t.window - (t.footer - a))
          } else l.css("bottom", t.footer); else n <= t.header ? !1 === s ? (l.css("top", t.header - n), r.css("height", t.window - (t.header - n))) : l.css("top", t.header) : !1 === s ? (l.css("top", 0), r.css("height", t.window)) : l.css("top", t.header)
        }
      }, t._fixHeight = function () {
        var e = i.default("body");
        if (e.hasClass("layout-fixed")) {
          var t = i.default(window).height(), a = i.default(".main-header").outerHeight(),
            n = i.default(".main-footer").outerHeight(), s = t - a;
          (e.hasClass("layout-footer-fixed") || e.hasClass("layout-sm-footer-fixed") || e.hasClass("layout-md-footer-fixed") || e.hasClass("layout-lg-footer-fixed") || e.hasClass("layout-xl-footer-fixed")) && "fixed" === i.default(".main-footer").css("position") && (s = t - a - n);
          var o = i.default(".control-sidebar .control-sidebar-content");
          o.css("height", s), "undefined" != typeof i.default.fn.overlayScrollbars && o.overlayScrollbars({
        ...
        return this.each((function () {
          var a = i.default(this).data("lte.controlsidebar"), n = i.default.extend({}, g, i.default(this).data());
  ...
  })), i.default.fn[c] = p._jQueryInterface, i.default.fn[c].Constructor = p, i.default.fn[c].noConflict = function () {
    return i.default.fn[c] = h, p._jQueryInterface
  };
  var m = "DirectChat", _ = i.default.fn[m], v = function () {
    function e(e) {
      this._element = e
    }
  ...
  i.default(document).on("click", '[data-widget="chat-pane-toggle"]', (function (e) {
    e && e.preventDefault(), v._jQueryInterface.call(i.default(this), "toggle")
  })), i.default.fn[m] = v._jQueryInterface, i.default.fn[m].Constructor = v, i.default.fn[m].noConflict = function () {
    return i.default.fn[m] = _, v._jQueryInterface
  };
  var b = "Dropdown", y = i.default.fn[b], C = {}, w = function () {
    function e(e, t) {
    ...
    return t.toggleSubmenu = function () {
      ...
      return this.each((function () {
        var a = i.default(this).data("lte.dropdown"), n = i.default.extend({}, C, i.default(this).data());
  ...
  i.default('.dropdown-menu [data-toggle="dropdown"]').on("click", (function (e) {
    e.preventDefault(), e.stopPropagation(), w._jQueryInterface.call(i.default(this), "toggleSubmenu")
  ...
  })), i.default.fn[b] = w._jQueryInterface, i.default.fn[b].Constructor = w, i.default.fn[b].noConflict = function () {
    return i.default.fn[b] = y, w._jQueryInterface
  };
  var x = "ExpandableTable", I = i.default.fn[x], j = function () {
    function e(e, t) {
    ...
    return t.init = function () {
      i.default('[data-widget="expandable-table"]').each((function (e, t) {
        var a = i.default(t).attr("aria-expanded"), n = i.default(t).next().children().first().children();
        "true" === a ? n.show() : "false" === a && (n.hide(), n.parent().parent().addClass("d-none"))
      }))
    }, t.toggleRow = function () {
      var e = this._element, t = e.attr("aria-expanded"), a = e.next().children().first().children();
      a.stop(), "true" === t ? (a.slideUp(500, (function () {
        e.next().addClass("d-none")
      })), e.attr("aria-expanded", "false"), e.trigger(i.default.Event("collapsed.lte.expandableTable"))) : "false" === t && (e.next().removeClass("d-none"), a.slideDown(500), e.attr("aria-expanded", "true"), e.trigger(i.default.Event("expanded.lte.expandableTable")))
    }, e._jQueryInterface = function (t) {
      return this.each((function () {
        var a = i.default(this).data("lte.expandableTable");
        a || (a = new e(i.default(this)), i.default(this).data("lte.expandableTable", a)), "string" == typeof t && t.match(/init|toggleRow/) && a[t]()
      }))
    }, e
  }();
  ...
  var Q = "Fullscreen", S = i.default.fn[Q],
    T = {minimizeIcon: "fa-compress-arrows-alt", maximizeIcon: "fa-expand-arrows-alt"}, z = function () {
      function e(e, t) {
      ...
      return t.toggle = function () {
        ...
        var n = i.default.extend({}, T, "object" == typeof t ? t : a), s = new e(i.default(this), n);
        i.default(this).data("lte.fullscreen", "object" == typeof t ? t : a), "string" == typeof t && t.match(/toggle|fullscreen|windowed/) ? s[t]() : s.init()
      }, e
    }();
  i.default(document).on("click", '[data-widget="fullscreen"]', (function () {
    z._jQueryInterface.call(i.default(this), "toggle")
  })), i.default.fn[Q] = z._jQueryInterface, i.default.fn[Q].Constructor = z, i.default.fn[Q].noConflict = function () {
    return i.default.fn[Q] = S, z._jQueryInterface
  };
  var k = i.default.fn.Layout, H = ".main-sidebar .sidebar",
    E = {scrollbarTheme: "os-theme-light", scrollbarAutoHide: "l", panelAutoHeight: !0, loginRegisterAutoHeight: !0},
    L = function () {
      function e(e, t) {
      ...
      return t.fixLayoutHeight = function (e) {
        ...
        (t.hasClass("control-sidebar-slide-open") || t.hasClass("control-sidebar-open") || "control_sidebar" === e) && (a = i.default(".control-sidebar-content").height());
        var n = {
          window: i.default(window).height(),
          header: 0 !== i.default(".main-header").length ? i.default(".main-header").outerHeight() : 0,
          footer: 0 !== i.default(".main-footer").length ? i.default(".main-footer").outerHeight() : 0,
          sidebar: 0 !== i.default(H).length ? i.default(H).height() : 0,
          controlSidebar: a
        }, s = this._max(n), o = this._config.panelAutoHeight;
        !0 === o && (o = 0);
        var l = i.default(".content-wrapper");
        !1 !== o && (s === n.controlSidebar ? l.css("min-height", s + o) : s === n.window ? l.css("min-height", s + o - n.header - n.footer) : l.css("min-height", s + o - n.header), this._isFooterFixed() && l.css("min-height", parseFloat(l.css("min-height")) + n.footer)), t.hasClass("layout-fixed") && (!1 !== o && l.css("min-height", s + o - n.header - n.footer), "undefined" != typeof i.default.fn.overlayScrollbars && i.default(H).overlayScrollbars({
          className: this._config.scrollbarTheme,
          sizeAutoCapable: !0,
          scrollbars: {autoHide: this._config.scrollbarAutoHide, clickScrolling: !0}
        }))
        ...
        var e = this;
        this.fixLayoutHeight(), !0 === this._config.loginRegisterAutoHeight ? this.fixLoginRegisterHeight() : this._config.loginRegisterAutoHeight === parseInt(this._config.loginRegisterAutoHeight, 10) && setInterval(this.fixLoginRegisterHeight, this._config.loginRegisterAutoHeight), i.default(H).on("collapsed.lte.treeview expanded.lte.treeview", (function () {
          e.fixLayoutHeight()
        ...
        return void 0 === t && (t = ""), this.each((function () {
          var a = i.default(this).data("lte.layout"), n = i.default.extend({}, E, i.default(this).data());
  ...
  })), i.default.fn.Layout = L._jQueryInterface, i.default.fn.Layout.Constructor = L, i.default.fn.Layout.noConflict = function () {
    return i.default.fn.Layout = k, L._jQueryInterface
  };
  var R = "PushMenu", F = i.default.fn[R], q = {autoCollapseSize: 992, enableRemember: !1, noTransitionAfterReload: !0},
    D = function () {
      function e(e, t) {
        this._element = e, this._options = i.default.extend({}, q, t), 0 === i.default("#sidebar-overlay").length && this._addOverlay(), this._init()
      }
      ...
      return t.expand = function () {
        ...
        return this.each((function () {
          var a = i.default(this).data("lte.pushmenu"), n = i.default.extend({}, q, i.default(this).data());
          a || (a = new e(this, n), i.default(this).data("lte.pushmenu", a)), "string" == typeof t && t.match(/collapse|expand|toggle/) && a[t]()
        }))
      }, e
    }();
  i.default(document).on("click", '[data-widget="pushmenu"]', (function (e) {
    ...
    "pushmenu" !== i.default(t).data("widget") && (t = i.default(t).closest('[data-widget="pushmenu"]')), D._jQueryInterface.call(i.default(t), "toggle")
  })), i.default(window).on("load", (function () {
    D._jQueryInterface.call(i.default('[data-widget="pushmenu"]'))
  })), i.default.fn[R] = D._jQueryInterface, i.default.fn[R].Constructor = D, i.default.fn[R].noConflict = function () {
    return i.default.fn[R] = F, D._jQueryInterface
  };
  var A = "SidebarSearch", P = i.default.fn[A], N = '[data-widget="sidebar-search"]', O = N + " .form-control", M = {
    arrowSign: "->",
    minLength: 3,
    maxResults: 7,
    highlightName: !0,
    ...
    function e(e, t) {
      this.element = e, this.options = i.default.extend({}, M, t), this.items = []
    }

    var a = e.prototype;
    return a.init = function () {
      var e = this;
      0 != i.default(N).length && (0 == i.default(N).next(".sidebar-search-results").length && i.default(N).after(i.default("<div />", {class: "sidebar-search-results"})), 0 == i.default(".sidebar-search-results").children(".list-group").length && i.default(".sidebar-search-results").append(i.default("<div />", {class: "list-group"})), this._addNotFound(), i.default(".main-sidebar .nav-sidebar").children().each((function (t, a) {
        e._parseItem(a)
      })))
    }, a.search = function () {
      var e = this, t = i.default(O).val().toLowerCase();
      ...
      i.default(".sidebar-search-results .list-group").empty(), 0 === n.length ? this._addNotFound() : n.each((function (t, a) {
        i.default(".sidebar-search-results .list-group").append(e._renderItem(a.name, a.link, a.path))
      })), this.open()
    }, a.open = function () {
      i.default(N).parent().addClass("sidebar-search-open"), i.default('[data-widget="sidebar-search"] .btn i').removeClass("fa-search").addClass("fa-times")
    }, a.close = function () {
      i.default(N).parent().removeClass("sidebar-search-open"), i.default('[data-widget="sidebar-search"] .btn i').removeClass("fa-times").addClass("fa-search")
    }, a.toggle = function () {
      i.default(N).parent().hasClass("sidebar-search-open") ? this.close() : this.open()
    }, a._parseItem = function (e, t) {
      var a = this;
      if (void 0 === t && (t = []), !i.default(e).hasClass("nav-header")) {
        var n = {}, s = i.default(e).clone().find("> .nav-link"), o = i.default(e).clone().find("> .nav-treeview"),
          l = s.attr("href"), r = s.find("p").children().remove().end().text();
        if (n.name = this._trimText(r), n.link = l, n.path = t, 0 === o.length) U.push(n); else {
      ...
      if (a = a.join(" " + this.options.arrowSign + " "), this.options.highlightName || this.options.highlightPath) {
        var s = i.default(O).val().toLowerCase(), o = new RegExp(s, "gi");
        this.options.highlightName && (e = e.replace(o, (function (e) {
          return '<b class="' + n.options.highlightClass + '">' + e + "</b>"
        }))), this.options.highlightPath && (a = a.replace(o, (function (e) {
          return '<b class="' + n.options.highlightClass + '">' + e + "</b>"
        })))
      }
      ...
      a || (a = i.default(this).data());
      var n = i.default.extend({}, M, "object" == typeof t ? t : a), s = new e(i.default(this), n);
      i.default(this).data("lte.sidebar-search", "object" == typeof t ? t : a), "string" == typeof t && t.match(/init|toggle|close|open|search/) ? s[t]() : s.init()
    }, e
  }();
  i.default(document).on("click", '[data-widget="sidebar-search"] .btn', (function (e) {
    ...
    if (38 == e.keyCode) return e.preventDefault(), void i.default(".sidebar-search-results .list-group").children().last().focus();
    if (40 == e.keyCode) return e.preventDefault(), void i.default(".sidebar-search-results .list-group").children().first().focus();
    var t = 0;
  ...
  })), i.default.fn[A] = B._jQueryInterface, i.default.fn[A].Constructor = B, i.default.fn[A].noConflict = function () {
    return i.default.fn[A] = P, B._jQueryInterface
  };
  var W = i.default.fn.Toasts, G = {
    position: "topRight",
    fixed: !0,
    autohide: !1,
    autoremove: !0,
    ...
    function e(e, t) {
      this._config = t, this._prepareContainer(), i.default("body").trigger(i.default.Event("init.lte.toasts"))
    }
    ...
    return t.create = function () {
      ...
      s.trigger(i.default.Event("created.lte.toasts")), e.toast("show"), this._config.autoremove && e.on("hidden.bs.toast", (function () {
        i.default(this).delay(200).remove(), s.trigger(i.default.Event("removed.lte.toasts"))
      }))
      ...
      return this.each((function () {
        var n = i.default.extend({}, G, a), s = new e(i.default(this), n);
        "create" === t && s[t]()
      }))
    }, e
  }();
  i.default.fn.Toasts = J._jQueryInterface, i.default.fn.Toasts.Constructor = J, i.default.fn.Toasts.noConflict = function () {
    return i.default.fn.Toasts = W, J._jQueryInterface
  };
  var K = "TodoList", V = i.default.fn[K], X = {
    onCheck: function (e) {
      return e
    ...
    return t.toggle = function (e) {
      ...
      return this.each((function () {
        ...
        a || (a = i.default(this).data());
        var n = i.default.extend({}, X, "object" == typeof t ? t : a), s = new e(i.default(this), n);
        i.default(this).data("lte.todolist", "object" == typeof t ? t : a), "init" === t && s[t]()
      }))
    }, e
  }();
  i.default(window).on("load", (function () {
    Y._jQueryInterface.call(i.default('[data-widget="todo-list"]'))
  })), i.default.fn[K] = Y._jQueryInterface, i.default.fn[K].Constructor = Y, i.default.fn[K].noConflict = function () {
    return i.default.fn[K] = V, Y._jQueryInterface
  };
  var Z = "Treeview", $ = i.default.fn[Z], ee = {
    ...
    var t = e.prototype;
    return t.init = function () {
      i.default(".nav-item.menu-open .nav-treeview").css("display", "block"), this._setupListeners()
    }, t.expand = function (e, t) {
      var a = this, n = i.default.Event("expanded.lte.treeview");
      if (this._config.accordion) {
        var s = t.siblings(".menu-open").first(), o = s.find(".nav-treeview").first();
        this.collapse(o, s)
      }
      ...
      if (n.is(".nav-treeview") || (a.is(".nav-item") || (n = a.parent().find("> .nav-treeview")), n.is(".nav-treeview"))) {
        ...
        s.hasClass("menu-open") ? this.collapse(i.default(n), s) : this.expand(i.default(n), s)
      }
      ...
      return this.each((function () {
        var a = i.default(this).data("lte.treeview"), n = i.default.extend({}, ee, i.default(this).data());
  ...
  })), i.default.fn[Z] = te._jQueryInterface, i.default.fn[Z].Constructor = te, i.default.fn[Z].noConflict = function () {
    return i.default.fn[Z] = $, te._jQueryInterface
  }, e.CardRefresh = l, e.CardWidget = f, e.ControlSidebar = p, e.DirectChat = v, e.Dropdown = w, e.ExpandableTable = j, e.Fullscreen = z, e.Layout = L, e.PushMenu = D, e.SidebarSearch = B, e.Toasts = J, e.TodoList = Y, e.Treeview = te, Object.defineProperty(e, "__esModule", {value: !0})
}));
